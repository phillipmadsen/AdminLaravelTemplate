#AffordableProgrammer CustomAdmin template Laravel package
A Laravel package that switch default Laravel scaffolding/boilerplate for custom Admin template
...
<pre>
 $ laravel new {your-project-name-here}
