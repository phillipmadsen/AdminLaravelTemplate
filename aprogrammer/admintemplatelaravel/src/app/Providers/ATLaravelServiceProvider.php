 ...
 *  Aprogrammer\AdminTemplateLaravel
 * Aprogrammer/AdminTemplateLaravel
 */
namespace Aprogrammer\AdminTemplateLaravel\app\Providers;

use Illuminate\Support\ServiceProvider;

/**
 * Class ATLaravelServiceProvider
 * @package Aprogrammer\AdminTemplateLaravel\app\Providers
 */
class ATLaravelServiceProvider extends ServiceProvider {
	...
	private function publishViews() {
		$this->loadViewsFrom(dirname(__FILE__) . '/../resources/views/', 'aptemplate');
		...
		$this->publishes([
			...
			dirname(__FILE__) . '/../../resources/views/admin.blade.php' => base_path('resources/views/admin.blade.php'),
			dirname(__FILE__) . '/../../resources/views/blank.blade.php' => base_path('resources/views/blank.blade.php'),
